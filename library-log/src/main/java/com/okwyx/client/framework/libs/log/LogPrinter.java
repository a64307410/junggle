...
public interface LogPrinter {
    ...
    LogPrinter t(String tag, int methodCount);
    ...
    public static class AndroidLoggerPrinter implements LogPrinter{
        private static final String DEFAULT_TAG = LogSettings.DEFAULT_TAG;


        private static final int DEBUG = LogSettings.DEBUG;
        private static final int ERROR = LogSettings.ERROR;
        private static final int ASSERT = LogSettings.ASSERT;
        private static final int INFO = LogSettings.INFO;
        private static final int VERBOSE = LogSettings.VERBOSE;
        private static final int WARN = LogSettings.WARN;

        /**
         * Android's 日志最大输出为 0~4076 bytes,
         * subString 4000
         */
        ...
        @Override public LogPrinter t(String tag, int methodCount) {
            if (tag != null) {
                localTag.set(tag);
            }
        ...
        @Override public synchronized void log(int priority, String tag, String message, Throwable throwable) {
            if (settings.getLogLevel() == LogSettings.LogLevel.NONE) {
                return;
            }
        ...
        private int getStackOffset(StackTraceElement[] trace) {
            for (int i = MIN_STACK_OFFSET; i < trace.length; i++) {
                ...
                if (!name.equals(AndroidLoggerPrinter.class.getName()) && !name.equals(Logger.class.getName())) {
                    return --i;
                }
            }
            return -1;

...
import com.okwyx.client.R;
import com.okwyx.client.R.anim;
import com.okwyx.client.R.color;
import com.okwyx.client.R.dimen;
import com.okwyx.client.R.drawable;
import com.okwyx.client.R.id;
import com.okwyx.client.R.layout;
import com.okwyx.client.R.string;
import com.okwyx.client.framework.libs.ui.view.theme.Theme;
...
public class PullDownView extends FrameLayout implements OnGestureListener, AnimationListener, IPullDownView {
    ...
    protected PullDownView.Flinger mFlinger = new PullDownView.Flinger();
...
//    private boolean mNeedAd;
    ...
    private PullDownView.OnScrollListener mOnScrollListener;
    ...
    private void initArrow() {
        Theme theme = Theme.getInstance(this.getContext().getApplicationContext());
        this.mUpArrow = theme.getDrawableFromIdentifier(drawable.tableview_pull_refresh_arrow_up);
        this.mDownArrow = theme.getDrawableFromIdentifier(drawable.tableview_pull_refresh_arrow_down);
    }
...
//    }
    ...
    public void setUpdateHandle(PullDownView.UpdateHandle handle) {
        this.mUpdateHandle = handle;
    }
    ...
    public void initSkin() {
        ...
        Drawable loadingDrawable = theme.getDrawableFromIdentifier(drawable.tableview_loading);
        ...
        this.mTitle1.setTextColor(theme.getColorFromIdentifier(color.common_gray_93));
        this.mTitle2.setTextColor(theme.getColorFromIdentifier(color.common_gray_93));
    }

    protected void addUpdateBar() {
        this.mAnimationUp = AnimationUtils.loadAnimation(this.getContext().getApplicationContext(), anim.rotate_up);
        this.mAnimationUp.setFillAfter(true);
        this.mAnimationUp.setFillBefore(false);
        this.mAnimationUp.setAnimationListener(this);
        this.mAnimationDown = AnimationUtils.loadAnimation(this.getContext().getApplicationContext(), anim.rotate_down);
        ...
        this.vUpdateBar = LayoutInflater.from(this.getContext().getApplicationContext()).inflate(layout.vw_update_bar, (ViewGroup)null);
    ...
    public void setOnScrollListener(PullDownView.OnScrollListener listener) {
